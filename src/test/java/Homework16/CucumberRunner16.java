...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/cucumber-reports/cucumber16.html",
                "json:target/cucumber-reports/cucumber16.json",
                "io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm"
        }
)
public class CucumberRunner16 extends AbstractTestNGCucumberTests {
